// CS 325 Data Structures - Clay Wieringa
//
// fall 2025
// lab1.java
//
...
class lab1 {
	...
	public static void main(String[] args) {
		...
		String first_name = "Clay";

		// (*** last_name of type String)
		String last_name = "Wieringa";
		...
		int values[] = { 17, 8, 24, 16, 20, 26, 7, 13, 19, 21 };
		...
		System.out.println(allSame(10, 20, 20));
		...
		if (allSame(value1, value2, value3))
			...
			System.out.println(value1 + ", " + value2 + ", and " + value3 + " are not the same");
